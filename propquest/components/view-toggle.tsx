...
export function ViewToggle({ activeView, mapHref = "/", listHref = "/listing" }: ViewToggleProps) {
  ...
  const activeMapClass = "bg-blue-gradient hover:opacity-90 border-0"
  const activeListClass = "bg-blue-gradient hover:opacity-90 border-0 text-white"
  const inactiveClass = "bg-white/90 hover:bg-white backdrop-blur-sm"
