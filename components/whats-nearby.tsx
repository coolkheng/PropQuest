...
export function WhatsNearby({ amenities }: WhatsNearbyProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-xl bg-clip-text text-transparent bg-blue-gradient">
          What's nearby
        </CardTitle>
      </CardHeader>
                    ...
                    {selectedPlace && (
                      <div className="absolute top-[-120px] left-[-100px] bg-white rounded-lg shadow-lg p-3 w-[220px]">
                        ...
                        <div className="flex items-center text-xs text-gray-500 mt-1">
                          ...
                          <span>
                            {
                              getNearbyPlaces().find(
                                (p) => p.name === selectedPlace
                              )?.time
                            }{" "}
                            •{" "}
                            {
